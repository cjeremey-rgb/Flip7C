(() => {
  const ensureLayoutFix = () => {
    ...
    if (!document.querySelector('link[data-multiplayer-card-size-pass]')) {
      const link = document.createElement('link'); link.rel='stylesheet'; link.href='./multiplayer-card-size-pass.css?v=20260906-size-v3'; link.dataset.multiplayerCardSizePass='1'; document.head.appendChild(link);
    }
  };
