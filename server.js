...
const ALLOWED_AVATARS = new Set(['avatar-1', 'avatar-2', 'avatar-3', 'avatar-4', 'avatar-5', 'avatar-6', 'avatar-7', 'avatar-8', 'avatar-9', 'avatar-10', 'avatar-nova', 'avatar-ace']);
...
function publicState(room) {
  ...
  return {
    ...
    players: room.players.map(player => ({
      ...player, connected: player.computer || Date.now() - player.lastSeen < 12000
    })),
